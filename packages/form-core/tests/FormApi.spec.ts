...
describe('form api', () => {
  ...
  it('should set all fields meta', () => {
    ...
    expect(nameField.state.meta.isTouched).toBe(true)
    expect(nameField.state.meta.isBlurred).toBe(true)
    expect(nameField.state.meta.isDirty).toBe(true)

    expect(ageField.state.meta.isTouched).toBe(true)
    expect(ageField.state.meta.isBlurred).toBe(true)
    expect(ageField.state.meta.isDirty).toBe(true)
  })
})
