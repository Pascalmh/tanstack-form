...
Defined in: [packages/form-core/src/standardSchemaValidator.ts:73](https://github.com/Pascalmh/tanstack-form/blob/main/packages/form-core/src/standardSchemaValidator.ts#L73)
